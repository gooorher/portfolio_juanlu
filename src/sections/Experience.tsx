  ...
  const experiences: JobExperience[] = [
    {
      ...
      responsibilities: [
        ...
        'Implementación de nuevas características y mejoras en la plataforma existente',
        'Colaboración con el equipo de diseño para crear interfaces intuitivas',
      ],
    },
    {
      company: 'Empresa 2',
      title: 'Desarrollador Frontend',
      range: 'Junio 2022 - Diciembre 2022',
      responsibilities: [
